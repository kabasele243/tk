...
function TranscribeBatch() {
  ...
  // Redux state
  const { files, statistics } = useSelector(state => state.fileProcessing);
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">
                  AI Audio Batch Processor
                </h1>
                <p className="text-sm text-gray-500 mt-1">
                  Upload Multiple Files → AI Processing → Bulk Downloads
                </p>
              </div>
            </div>
        ...
        {stats.total > 0 && (
          <div className="mb-8 bg-white/60 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-200/50">
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-sm text-gray-600">{stats.completed}/{stats.total} files completed</span>
            </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-200/50">
              ...
              >
                ...
                <p className="text-sm text-gray-500 mb-4">
                  Select multiple audio/video files for batch processing
                </p>
                <div className="flex flex-wrap justify-center gap-2 text-xs text-gray-600">
                  {['MP3', 'WAV', 'M4A', 'FLAC', 'MP4', 'AVI', 'MOV', 'MKV'].map((format) => (
                    <span key={format} className="px-2 py-1 bg-gray-100 rounded font-medium">
                      {format}
                    </span>
                  ))}
                </div>
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-200/50">
              ...
              <div className="mb-4">
                ...
                <select
                  value={aiSettings.selectedPromptType}
...
export default TranscribeBatch;